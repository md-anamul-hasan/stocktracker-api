...
CREATE TABLE IF NOT EXISTS stocks (
  ...
  swing_low_60 REAL DEFAULT 0,
  swing_high_60 REAL DEFAULT 0,
  avg_daily_turnover REAL DEFAULT 0,
  free_float REAL DEFAULT 0,
  floor_price REAL DEFAULT 0,
  own_median_pe REAL DEFAULT 0,
  own_std_pe REAL DEFAULT 0,
  stock_character TEXT DEFAULT 'balanced',
